...
const Guide = () => {
  return (
    <div className=' xl:w-64 lg:w-52 w-48 absolute right-5 top-19 py-10 gap-8 px-6 lg:flex hidden text-center flex-col rounded-md bg-gray-100 '>
        <h1 className='text-2xl font-bold '>User Guide 👁‍🗨</h1>
        <p className=''>With weshare, you can share your thoughts and bring them to reality ✔🔥 <br />
