...
const Guide = () => {
  return (
    <div className=' xl:w-64 lg:w-52 w-48 absolute right-5 top-40 py-10 gap-8 px-6 lg:flex hidden text-center flex-col rounded-md bg-gray-100 dark:bg-gray-800'>
