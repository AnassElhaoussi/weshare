  ...
  return (
    <div className="flex flex-wrap gap-4 justify-between py-2 px-6 items-center bg-white">
        ...
        <div className='relative'>
            <input type="text" placeholder='Filter by tag' className='bg-gray-100 py-1 px-10 rounded outline-none' value={searchValue} onChange={(e) => setSearchValue(e.target.value)} />
        </div>
